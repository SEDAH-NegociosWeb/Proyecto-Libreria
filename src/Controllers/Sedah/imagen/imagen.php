...
\Utilities\Site::redirectToWithMsg("index.php?page=mnt.imagen.imagenLista","Sucedio un error al procesar la pagina");
}
...
if(!isset($_SESSION["imagen_crsxToken"]) || $_SESSION["imagen_crsxToken"] !== $this->_viewData["crsxToken"]){
   ...
   \Utilities\Site::redirectToWithMsg("index.php?page=mnt.imagen.imagenLista","Ocurrio un error, no se puede procesar");
       }
...
case "INS":
$result = \Dao\Mnt\imagen::insertarimagen(
$this->_viewData["direccion"]
);
if ($result) {
\Utilities\Site::redirectToWithMsg(
"index.php?page=mnt.imagen.imagenLista",
"¡Registro guardado exitosamente!"
);
}
break;
case "UPD":
$result = \Dao\Mnt\imagen::actualizarimagen(
...
break;
case "DEL":
$result = \Dao\Mnt\imagen::eliminarimagen(
$this->_viewData["idImagen"]
);
if ($result) {
\Utilities\Site::redirectToWithMsg(
...
$tmpimagen = \Dao\Mnt\imagen::obtenerPorId(intval($this->_viewData["idImagen"],10));
...
Renderer::render("mnt/imagen", $this->_viewData);
}
}
?>