...
\Utilities\Site::redirectToWithMsg("index.php?page=mnt.editorial.editorialLista","Sucedio un error al procesar la pagina");
}
...
if(!isset($_SESSION["editorial_crsxToken"]) || $_SESSION["editorial_crsxToken"] !== $this->_viewData["crsxToken"]){
   ...
   \Utilities\Site::redirectToWithMsg("index.php?page=mnt.editorial.editorialLista","Ocurrio un error, no se puede procesar");
       }
...
case "INS":
$result = \Dao\Mnt\editorial::insertareditorial(
...
"index.php?page=mnt.editorial.editorialLista",
"¡Registro guardado exitosamente!"
);
}
break;
case "UPD":
$result = \Dao\Mnt\editorial::actualizareditorial(
...
break;
case "DEL":
$result = \Dao\Mnt\editorial::eliminareditorial(
$this->_viewData["idEditorial"]
);
if ($result) {
\Utilities\Site::redirectToWithMsg(
...
$tmpeditorial = \Dao\Mnt\editorial::obtenerPorId(intval($this->_viewData["idEditorial"],10));
...
Renderer::render("mnt/editorial", $this->_viewData);
}
}
?>