...
\Utilities\Site::redirectToWithMsg("index.php?page=mnt.usuario.usuarioLista","Sucedio un error al procesar la pagina");
}
...
if(!isset($_SESSION["usuario_crsxToken"]) || $_SESSION["usuario_crsxToken"] !== $this->_viewData["crsxToken"]){
   ...
   \Utilities\Site::redirectToWithMsg("index.php?page=mnt.usuario.usuarioLista","Ocurrio un error, no se puede procesar");
       }
...
case "INS":
$result = \Dao\Mnt\usuario::insertarusuario(
...
"index.php?page=mnt.usuario.usuarioLista",
"¡Registro guardado exitosamente!"
);
}
break;
case "UPD":
$result = \Dao\Mnt\usuario::actualizarusuario(
...
break;
case "DEL":
$result = \Dao\Mnt\usuario::eliminarusuario(
$this->_viewData["usercod"]
);
if ($result) {
\Utilities\Site::redirectToWithMsg(
...
$tmpusuario = \Dao\Mnt\usuario::obtenerPorId(intval($this->_viewData["usercod"],10));
...
Renderer::render("mnt/usuario", $this->_viewData);
}
}
?>