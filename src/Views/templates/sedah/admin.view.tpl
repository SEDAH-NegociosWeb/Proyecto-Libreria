<div class="container-fluid text-center" style="padding-top: 10rem; height: 50rem;">
    ...
    <div class="row" style="height: 200px; padding-top: 20px;">
        ...
        <div class="col-md-4">
            <button type="button" class="btn btn-info" style="height: 110px; width: 200px;"
                onclick="location.href='index.php?page=sedah_editorial_editorialLista'"><strong>Editorial</strong>
            </button>
        </div>
        <div class="col-md-4">
            <button type="button" class="btn btn-info" style="height: 110px; width: 200px;"
                onclick="location.href='index.php?page=sedah_autor_autorLista'"><strong>Autor</strong>
            </button>
        </div>
    </div>
    <div class="row" style="height: 200px;">
        ...
        <div class="col-md-4">
            <button type="button" class="btn btn-info" style="height: 110px; width: 200px;"
                onclick="location.href='index.php?page=sedah_categoria_categoriaLista'"><strong>Categoria</strong>
            </button>
        </div>
        <div class="col-md-4">
            <button type="button" class="btn btn-info" style="height: 110px; width: 200px;"
