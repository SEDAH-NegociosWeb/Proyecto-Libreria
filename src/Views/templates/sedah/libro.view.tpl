...
<fieldset class="row flex-center align-center">
                <label for="anio" class="col-5">anio</label>
...
<fieldset class="row flex-center align-center">
                ...
                <input class="col-7" id="idCategoria" name="idCategoria" value="{{idCategoria}}" placeholder="" type="text">
            </fieldset>
<fieldset class="row flex-center align-center">
                <label for="existencia" class="col-5">existencia</label>
                <input class="col-7" id="existencia" name="existencia" value="{{existencia}}" placeholder="" type="text">
            </fieldset>
